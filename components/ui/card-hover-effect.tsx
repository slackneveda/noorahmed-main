...
export const CardTitle = ({
  ...
  return <h4 className={cn("text-xl font-bold tracking-wide mt-4", className)}>{children}</h4>
}
...
export const CardDescription = ({
  ...
  return <p className={cn("mt-2 text-muted-foreground tracking-wide leading-relaxed", className)}>{children}</p>
}
